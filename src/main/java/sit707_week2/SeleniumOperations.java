...
public class SeleniumOperations {
	...
	public static void officeworks_registration_page(String url) {
	    ...
	    try {
	        FileUtils.copyFile(scrFile, new File("/Users/yuhengwang/Desktop/IT material/2024 T1/SIT707 software testing/task2_1P/screenShot.png"));
	    } catch (IOException e) {
	        e.printStackTrace();
	    }
